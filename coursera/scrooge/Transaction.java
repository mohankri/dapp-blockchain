...
public class Transaction {
    ...
    public Transaction() {
        //System.out.println("Create Transaction empty");
        inputs = new ArrayList<Input>();
        outputs = new ArrayList<Output>();
    }

    public Transaction(Transaction tx) {
          //      System.out.println("Create Transaction noempty");
    ...
    public void addInput(byte[] prevTxHash, int outputIndex) {
        //System.out.println("addInput " + Arrays.toString(prevTxHash));
    ...
    public byte[] getRawDataToSign(int index) {
        ...
        byte[] prevTxHash = in.prevTxHash;
                //System.out.println("getRawDataToSign " + Arrays.toString(prevTxHash));
    ...
    public void setHash(byte[] h) {
                        //System.out.println("setHash " + Arrays.toString(hash));

        hash = h;
    }

    public byte[] getHash() {
                //System.out.println("getHash " + Arrays.toString(hash));
